        ...
        <Row style={{ alignItems: "center", justifyContent: "center" }}>
          ...
          <Form.Group as={Col} md="2" controlId="validationCustom01">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setFechaFinalPago(e.target.value);
              }}
            />
          </Form.Group>
          <Form.Group as={Col} md="2" controlId="validationCustom01">
          ...
          <Form.Group as={Col} md="2" controlId="validationCustom01">
            <Button
              style={{ marginTop: "30px", marginLeft: "1em" }}
              onClick={CrearNewFactura}
            >
              Crear Factura
            </Button>
          </Form.Group>
                            ...
                            <tbody>
                              {Recibos.map((rec) => (
                                <tr key={rec.idRecibo}>
                                  ...
                                  <td>
                                    <Button
                                      onClick={() => DeleteRecibo(rec.idRecibo)}
                                    >
                                      Eliminar
                                    </Button>
                                  </td>
